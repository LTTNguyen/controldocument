...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'ANDES Suministros SPA');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'Servicios Eléctricos TyM LTDA');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Pedido de Materiales, Servicios, Herramientas y Equipos');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "https://www.tymelectricos.cl");
}
